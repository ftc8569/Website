...
const ImageDropAndCrop: React.FC<ImageDropAndCropProps> = ({
  ...
  const handleSave = () => {
    onSave(croppedAreaPixels != null ? croppedAreaPixels : {
      x: 0,
      y: 0,
      ...
      {!image ? (
        ...
        >
          ...
          <div className="text-center p-5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 mx-auto text-neutral-500">
        ...
        <div className="relative w-full h-full bg-neutral-100 rounded-lg overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-16 flex items-center justify-center px-4 bg-white/90 border-b border-neutral-200 z-10">
            <div className="grid grid-cols-5 gap-2">
              ...
              <button
                ...
                aria-label="Move up"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="w-5 h-5 rotate-90">
                  <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" />
                </svg>
              </button>
              <button
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="w-5 h-5 rotate-270">
                  <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" />
                </svg>
              </button>
              <button
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="w-5 h-5 rotate-180">
                  <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" />
                </svg>
              </button>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-16 flex items-center justify-between px-4 bg-white/90 border-t border-neutral-200">
            <div className="flex items-center gap-2 flex-1">
              <label htmlFor="zoom" className="text-sm font-medium text-stone-900">Zoom</label>
              <input
                id="zoom"
                type="range"
                min={minZoom}
