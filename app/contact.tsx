...
export default function ContactUs({ divRef }: { divRef: MutableRefObject<HTMLDivElement | null> }) {
  ...
  return (
    <div className="py-10 bg-[#151515] px-2 lg:px-56" ref={divRef}>
      <div className="flex items-center justify-center pb-5">
        <h1 className="inline text-3xl lg:text-4xl p-3 bg-roboPink text-black rounded-2xl mt-2 mb-4">Contact Us</h1>
      </div>
      <div className="flex flex-col lg:flex-row gap-5">
        <textarea
          form="contact-form"
          className={"w-full lg:w-2/3 h-36 p-1 bg-[#363636] rounded border-2 " + (validEntry ? "border-roboPink" : "border-red-500")}
          placeholder="I was wondering how you guys did..."
          name="entry"
        />
        <form id="contact-form" className="w-full lg:w-1/3" action={send} ref={formRef}>
