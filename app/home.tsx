  ...
  return (
    <div className="flex flex-row" ref={divRef}>
      <div className="flex-1 flex flex-col p-3 lg:p-10">
        ...
        <h1 className="text-4xl lg:text-6xl p-3 lg:p-4 bg-roboPink text-black rounded-2xl w-min mt-1 mb-4">RoboKnights</h1>
        <p className="text-sm lg:text-xl pl-2">Team 8569 is a competitive high-school robotics team
        ...
        <div className="bg-[#151515] p-2 rounded-2xl mt-4">
          <div className="flex items-center justify-center">
            <h1 className="inline text-2xl lg:text-3xl p-3 bg-roboPink text-black rounded-2xl mt-2 mb-4">North Carolina School of
              Science and Mathematics</h1>
          </div>
          <p className="text-sm lg:text-xl pl-2">The North Carolina School of
        ...
        <div className="bg-[#151515] p-2 rounded-2xl mt-4">
          <div className="flex items-center justify-center">
            <h1 className="text-2xl lg:text-3xl p-3 bg-roboPink text-black rounded-2xl inline mt-2 mb-4">FIRST Tech Challenge</h1>
          </div>
          <p className="text-sm lg:text-xl pl-2">FIRST Tech Challenge (FTC)
