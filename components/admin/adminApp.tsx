            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-stone-800 rounded-lg overflow-hidden">
                <thead className="bg-stone-700">
                  <tr>
                    <th className="py-3 px-4 text-left text-stone-100">
                      Title
                    </th>
                    <th className="py-3 px-4 text-left text-stone-100">
                      Author
                ...
                <tbody>
                  {blogs.length === 0 ? (
                    <tr>
                      <td
                        colSpan={6}
                        className="py-4 px-4 text-center text-stone-300"
                      >
                        No blog posts found
                      </td>
                    </tr>
                    ...
                    blogs.map((blog) => (
                      <tr
                        key={blog.id}
                        className="border-t border-stone-700 hover:bg-stone-700/50 transition-colors"
                      >
                        ...
                        <td className="py-3 px-4">
                          <span
                            className={`px-2 py-1 text-xs font-semibold rounded-full ${blog.published ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                          >
...
function BlogEditor({
  ...
  const handleUpdatePost = async () => {
    ...
    if (imageChanged && imageSrc)
      updateData.image = await convertToBase64(imageSrc)
    ...
    <>
      <div className="p-10">
        ...
        <div className="flex flex-row gap-x-4">
          <div>
            <p className={`text-3xl font-semibold text-stone-100 pb-2`}>
              Cover Image:
            </p>
            <div
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div>
              <p className={`text-lg font-semibold text-stone-100 pb-1`}>
                Title:
              </p>
